            ...
            <div className="w-full max-w-md animate-fade-in">
                <div className="text-center mb-8">
                    <Link href="/" className="inline-block">
                        <h1 className="text-3xl font-bold text-white">🚀 GBP Pro</h1>
                    </Link>
                    <p className="text-blue-100 mt-2">Start managing your Google Business Profile</p>
                </div>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-xs">
                                <span className="bg-transparent px-2 text-blue-200">or sign up with email</span>
                            </div>
                        </div>
